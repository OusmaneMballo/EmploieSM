<?php
/* Smarty version 3.1.30, created on 2020-05-18 03:40:34
  from "/Applications/XAMPP/xamppfiles/htdocs/Mes Sites/DITI/Emploie/src/view/welcome/index.html" */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.30',
  'unifunc' => 'content_5ec1e792a202a3_14063256',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '2413e75b1eb13c2ec2893763b8f5cd0a3a9bfe8d' => 
    array (
      0 => '/Applications/XAMPP/xamppfiles/htdocs/Mes Sites/DITI/Emploie/src/view/welcome/index.html',
      1 => 1589233130,
      2 => 'file',
    ),
  ),
  'includes' => 
  array (
    'file:src/view/welcome/footer.html' => 1,
  ),
),false)) {
function content_5ec1e792a202a3_14063256 (Smarty_Internal_Template $_smarty_tpl) {
?>
<!DOCTYPE html>
<html lang="en">
<head>
	<title>Liguey.sn</title>
	<meta charset="utf-8">
...
login/index">LigueyeSN</a>
		<a class="navbar-brand" href="<?php echo $_smarty_tpl->tpl_vars['url_base']->value;?>
login/index">Se connecter</a>
...
welcome/index" class="nav-link">Home</a></li>
				<li class="nav-item"><a href="browsejobs.html" class="nav-link">Voir Offres</a></li>
				<li class="nav-item"><a href="contact.html" class="nav-link">Contact</a></li>
				<li class="nav-item cta mr-md-1"><a href="<?php echo $_smarty_tpl->tpl_vars['url_base']->value;?>
login/index" class="nav-link">Poster une Offre</a></li>
				<li class="nav-item cta cta-colored"><a href="<?php echo $_smarty_tpl->tpl_vars['url_base']->value;?>
login/index" class="nav-link">Want a Job</a></li>
		...
		<div class="row d-md-flex no-gutters slider-text align-items-center justify-content-center">
			<div class="col-md-10 d-flex align-items-center ftco-animate">
				<div class="text text-center pt-5 mt-md-5">
					<p class="mb-4">Trouvez votre premier emploi ici! sur Liguey.sn</p>
					<h1 class="mb-5">Decrochez un rendez-vous d'entretien sans se deplacer!...</h1>
						...
						<div class="testimony-wrap py-4">
							<div class="text">
								...
								<div class="d-flex align-items-center">
									<div class="user-img" style="background-image: url('<?php echo $_smarty_tpl->tpl_vars['url_base']->value;?>
public/template/images/person_1.jpg');"></div>
									<div class="pl-3">
					...
					<div class="item">
						<div class="testimony-wrap py-4">
							<div class="text">
								...
								<div class="d-flex align-items-center">
									<div class="user-img" style="background-image: url('<?php echo $_smarty_tpl->tpl_vars['url_base']->value;?>
public/template/images/person_2.jpg');"></div>
									<div class="pl-3">
										<p class="name">Roger Scott</p>
										<span class="position">Marketing Manager</span>
									</div>
					...
					<div class="item">
						<div class="testimony-wrap py-4">
							<div class="text">
								...
								<div class="d-flex align-items-center">
									<div class="user-img" style="background-image: url('<?php echo $_smarty_tpl->tpl_vars['url_base']->value;?>
public/template/images/person_3.jpg');"></div>
									<div class="pl-3">
										<p class="name">Roger Scott</p>
										<span class="position">Marketing Manager</span>
									</div>
...
<?php $_smarty_tpl->_subTemplateRender("file:src/view/welcome/footer.html", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, $_smarty_tpl->cache_lifetime, array(), 0, false);
}
}
